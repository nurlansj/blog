    ...
    <main class="blog-post">
        <div class="container">
            ...
            <p class="edica-blog-post-meta" data-aos="fade-up" data-aos-delay="200">{{ $date->translatedFormat('F') }}
                {{ $date->day }}, {{ $date->year }}• {{ $date->format('H:i') }}• Кол-во
            ...
            <div class="row">
                <div class="col-lg-9 mx-auto">
                    <div class="row">
                        <section class="py-3 mx-auto">
                            ...
                            <form action="{{ route('post.liked.store', $post->id) }}" method="post">
                                @csrf
                                <span class="fa-2x">{{ $post->liked_users_count }}</span>
                    ...
                    @endif
                    <h2 class="section-title mb-3" data-aos="fade-up">Комментарий ({{ $post->comments->count() }})</h2>
